...
/** Dwie flagi przełączające język (pasek AuthLayout). Styl: .AuthHeader__flags img. */
export const ChangeLang = (props: Props) => {
    ...
    return (
        <>
            <img src={plFlag} onClick={() => changeLang(userLangEnum.pl)} alt="pl"/>
            <img src={enFlag} onClick={() => changeLang(userLangEnum.en)} alt="en"/>
        </>
    );
};
