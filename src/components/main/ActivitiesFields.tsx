...
import { AddBreak } from "./actions/AddBreak";
        ...
        return (
            <>
                <fieldset className="DivInline">
                    ...
                    <NavigateButton activityForm='addBreak' set={setActivityForm} text={props.dayData?.doubleCrew ? home[props.lang].driverChange : home[props.lang].addBreak}/><br/>
